...
with open("/home/srs-9/Projects/prl_project/training/test_train0/subjects.txt", 'r') as f:
    subjects = [line.strip() for line in f.readlines()]

dataroot = Path("/media/smbshare/3Tpioneer_bids")
script = "/home/srs-9/Projects/prl_project/training/test_train0/createLabels.sh"
